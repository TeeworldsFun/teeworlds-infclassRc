...
/* INFECTION MODIFICATION START ***************************************/
	...
	SetFireDelay(INFWEAPON_WITCH_PORTAL_LASER, GetFireDelay(INFWEAPON_LASER));
	SetFireDelay(INFWEAPON_ROCKET, 250);
	...
	SetAmmoRegenTime(INFWEAPON_WITCH_PORTAL_LASER, 5000);
	SetAmmoRegenTime(INFWEAPON_ROCKET, 1400);
	...
	SetMaxAmmo(INFWEAPON_ROCKET, 10);
	...
	SetClassAvailability(PLAYERCLASS_BETA, 2);
